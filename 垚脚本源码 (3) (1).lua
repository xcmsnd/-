...
CoreGui:SetCore("SendNotification", {
    Title = "启动成功",
    Text = "您好"..game.Players.LocalPlayer.Name.."，欢迎使用垚脚本",
    Duration = 5,
})
...
game:GetService("StarterGui"):SetCore("SendNotification",{ Title = "垚脚本"; Text ="载入中"; Duration = 2; })wait("3")

game:GetService("StarterGui"):SetCore("SendNotification",{ Title = "垚脚本"; Text ="缝合"; Duration = 2; })wait("2")

game:GetService("StarterGui"):SetCore("SendNotification",{ Title = "俄亥俄州用不了"; Text ="看见的我操死你"; Duration = 2; })wait("2")

game:GetService("StarterGui"):SetCore("SendNotification",{ Title = "垚脚本"; Text ="载入成功"; Duration = 3; })
...
local xynbui = loadstring(game:HttpGet("https://raw.githubusercontent.com/xcmsnd/QQ515966991/refs/heads/main/Ware_UI%20AL%E9%AB%98%E4%BB%BFV1.0.lua"))();
local win = xynbui:new("垚脚本")
--
